...
chrome.runtime.onMessage.addListener(function(request, sender, sendRespponse){
    //sendResponse: send response back
    //sender: can be popup/background
...
function insertMushroom(){
    ...
    //div is stored in variable mushroombox

    mushroomBox.innerHTML = data
    //whatever html is within mushroombox, set it equal to data(the link)
